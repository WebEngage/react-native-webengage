...
WebEngagePlugin.prototype.screen=function(name,data){
	if(data === undefined) {
		...
		WebEngage.screenNavigreatedWithData(name,data);
	}
}
...
WebEngagePushChannel.prototype.onClick = function (uri,callback) {
...
function WebEngageNotificationChannel () {
	...
	webengage.addListener('notificationClicked', (data) => this.clickCallback(data));
